...
Hello. Want to get started with Flask quickly? Good. You came to the right place. This Flask application framework is pre-configured with **Flask-MySQL**, **Registeration**, **Login**, **Logout**, **Session**, and the **Bootstrap** frontend (among others). This will get your Flask app up and running on Heroku or PythonAnywhere quickly. Use this starter, boilerplate for all your new Flask projects. Cheers!

<hr>

![zuhairabs-logo](https://raw.githubusercontent.com/zuhairabs/portfolio/master/src/static/logo.svg)
...
1. Clone the repo
  ```
  $ git clone https://github.com/zuhairabs/flask_login.git
  $ cd flask_login
  ```
...
4. Clone this repo:
  ```
  $ git clone git://github.com/zuhairabs/flask_login.git
  $ cd flask_login
  ```
...
5. DEVELOP YOUR APP - need [help](http://zuhairabs.github.io)?
...
1. [Zuhair Abbas](http://www.zuhairabs.github.io) :)
